 ...
 * a new string with the first occurance of the given substring in the source
 * replaced with another substring. The second argument (the substring to search
 * for) must not be empty, but can be blank. Refer to the JDK method of
 * {@link String#replaceFirst(String, String)} for basic description of how this
 ...
 */
public class ReplaceOnce implements Function {
	/**
	 ...
	 * 
	 * @return Returns a string with the first occurence of the search substring
	...
	public FunctionResult execute(final Evaluator evaluator, final String arguments)
		...
		try {
			...
			if (strIndex != -1) {
				...
				result = sb.replace(strIndex, strIndex + argumentTwo.length(),
