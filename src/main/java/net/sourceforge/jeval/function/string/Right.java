 ...
 * a string composed of the last N characters of the source string, or whole
...
public class Right implements Function {
	 ...
	 *            string. The second argument is the number of characters before
	 *            the end of the source string to return; this number must be
	 ...
	 * 
	 * @return Returns a substring made up of N characters from the tail end of
	 *         the source string, or whole string if N is greater than its length.
	 * 
	...
	public FunctionResult execute(final Evaluator evaluator, final String arguments)
		...
		try {
			...
			if (argumentTwo <= 0) {
				...
				result = argumentOne.substring(argumentOne.length() - argumentTwo);
			}
		} catch (Exception e) {
